...
read1 = read.csv(file="./data/pakkhi.csv", header = TRUE,sep = ",")
...
#to bring the google sheet to ur r do the following steps:
url_gsheet = "https://docs.google.com/spreadsheets/d/1AaYXVe9laELL_0T-aNWwNiiNkOJi8_hTho1tq5MRbxM/edit?usp=sharing"
